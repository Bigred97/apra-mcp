...
ADI_KEY_STATS · ADI_RISK_WEIGHTED_ASSETS · SUPER_FUND_LEVEL · INSURANCE_GENERAL (+ historical) · LIFE_INSURANCE (+ historical) · INSURANCE_HEALTH · QUARTERLY_SUPER_PERFORMANCE · ADI_PROPERTY_EXPOSURES · MONTHLY_BANKING_STATS · ADI_PERFORMANCE
...
- `parsing.py — XLSX reader (long-format pivots common for ADI / super fund data)`
- `discovery.py — CKAN auto-discovery for data.gov.au mirrors`
...
source_url         https://www.apra.gov.au/quarterly-statistics
...
uvx --refresh --from apra-mcp==<ver> python -c "..."         # smoke a published wheel
```
